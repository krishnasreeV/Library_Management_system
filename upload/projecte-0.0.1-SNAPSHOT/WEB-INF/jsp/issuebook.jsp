...
<html>
    ...
    <body>
        ...
        <form:form method="post" modelAttribute="IssuedBook">
            <table id="course-table">
                
             
                  <tr>
                      <td> Select book name:</td><td> 
                     <form:select path="bookdetails.book_id" >
                           
                         <form:options items="${books}"></form:options>
                          
                      </form:select></td><br><br></tr>
             
                  <tr>
                    <td> Select issuer :</td><td>  <form:select path="issuerdetails.issuer_id" >
                           
                            <form:options items="${issuers}" ></form:options>
                          
                      </form:select></td><br><br></tr>
                  
              <tr>  
                  <td colspan="2"> <input type="submit" value="Issue book"></td></tr>
            </table>
        </form:form>
    </body>
</html>
