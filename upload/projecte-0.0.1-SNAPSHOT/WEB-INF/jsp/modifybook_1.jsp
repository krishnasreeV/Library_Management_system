...
<html>
    ...
    <body>
        ...
        <form:form method="post" modelAttribute="BookA">
            Book Id: <form:input path="book_id" readonly="true"></form:input><br><br>
            Enter book name: <form:input path="book_name"></form:input><br><br>
             Author:<form:select path="authordetails.author_id" >
                         <form:options items="${authors}"></form:options>
                      </form:select>
            <br><br>
           Genre:<form:select path="genredetails.genre_id" >
                            <form:options items="${genres}" ></form:options>
            </form:select></td><br><br>
            <br><br>
            Enter count of books: <form:input path="count"></form:input><br><br>
