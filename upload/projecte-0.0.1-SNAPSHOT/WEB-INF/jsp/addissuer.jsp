    ...
    <body>
        ...
        <form:form method="post" modelAttribute="Issuers">
            <table id="course-table">
                <tr>
                    <td> Enter issuer name:</td><td> <form:input path="name" ></form:input></td><br><br></tr>
              <tr> 
                  <tr>
                    <td> Enter maximum issues:</td><td> <form:input path="max_issue" ></form:input></td><br><br></tr>
              <tr>
                  <td colspan="2"> <input type="submit" value="Add issuer"></td></tr>
            </table>
        </form:form>
    </body>
</html>
