...
<html>
    ...
    <body>
        ...
        <form:form method="post" modelAttribute="Genre">
            Author Id: <form:input path="genre_id" readonly="true"></form:input><br><br>
            Enter author name: <form:input path="genre_name"></form:input><br><br>
            <input type="submit" value="Modify genre">
        </form:form>
    </body>
</html>
