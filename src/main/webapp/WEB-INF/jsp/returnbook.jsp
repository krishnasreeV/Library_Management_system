...
<html>
    ...
    <body>
        ...
        <form:form method="post" modelAttribute="Returnbook">
            <table id="course-table">
                
                  <tr>
                      <td>Select book name:</td><td> 
                     <form:select path="issuedbookdetails.ib_id" >
                           
                         <form:options items="${issuedbooks}"></form:options>
                          
                      </form:select></td><br><br></tr>
             
              <tr>  
                  <td colspan="2"> <input type="submit" value="Return book"></td></tr>
            </table>
        </form:form>
    </body>
</html>
